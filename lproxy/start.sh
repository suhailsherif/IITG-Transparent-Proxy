...
echo "acl lan src 10.42.0.0/18" >> /etc/squid3/squid.conf
echo "acl lan src 192.168.0.0/18" >> /etc/squid3/squid.conf
echo "acl lan src 172.16.0.0/12" >> /etc/squid3/squid.conf
