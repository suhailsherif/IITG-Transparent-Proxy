...
public:
    ...
    QLineEdit *in_text_cproxy_ip;
    QLineEdit *in_text_cproxy_port;
    QLabel *in_text_vproxy_path_6;
    QPushButton *in_button_save_cproxy;
    QWidget *page_vproxy;
    QGroupBox *group_vpn;
...
"}"));
        ...
        toolbox_main->setGeometry(QRect(10, 10, 551, 411));
        QFont font;
        font.setBold(false);
        font.setWeight(50);
...
""));
        ...
        page_nproxy->setGeometry(QRect(0, 0, 551, 163));
        ...
        in_text_nproxy_password->setGeometry(QRect(130, 40, 131, 27));
        ...
        in_text_nproxy_port->setGeometry(QRect(420, 10, 71, 27));
        in_text_nproxy_port->setMaxLength(5);
        label_4 = new QLabel(group_proxy);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(10, 40, 121, 20));
        QFont font1;
        ...
        in_text_nproxy_server->setGeometry(QRect(420, 40, 113, 27));
        ...
        in_text_nproxy_username->setGeometry(QRect(130, 10, 131, 27));
        ...
        in_text_nproxy_gateway->setGeometry(QRect(420, 80, 113, 27));
        ...
        label->setGeometry(QRect(320, 40, 91, 17));
        label->setFont(font1);
        label_2 = new QLabel(group_proxy);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 10, 121, 17));
        label_2->setFont(font1);
        label_8 = new QLabel(group_proxy);
        label_8->setObjectName(QStringLiteral("label_8"));
        label_8->setGeometry(QRect(290, 80, 131, 20));
        ...
        in_button_save_nproxy->setGeometry(QRect(100, 110, 141, 27));
        ...
        page_cproxy->setGeometry(QRect(0, 0, 551, 163));
        in_text_vproxy_path_5 = new QLabel(page_cproxy);
        in_text_vproxy_path_5->setObjectName(QStringLiteral("in_text_vproxy_path_5"));
        in_text_vproxy_path_5->setGeometry(QRect(20, 10, 21, 31));
        in_text_cproxy_ip = new QLineEdit(page_cproxy);
        in_text_cproxy_ip->setObjectName(QStringLiteral("in_text_cproxy_ip"));
        in_text_cproxy_ip->setGeometry(QRect(50, 10, 131, 27));
        in_text_cproxy_port = new QLineEdit(page_cproxy);
        in_text_cproxy_port->setObjectName(QStringLiteral("in_text_cproxy_port"));
        in_text_cproxy_port->setGeometry(QRect(50, 40, 131, 27));
        in_text_vproxy_path_6 = new QLabel(page_cproxy);
        in_text_vproxy_path_6->setObjectName(QStringLiteral("in_text_vproxy_path_6"));
        in_text_vproxy_path_6->setGeometry(QRect(10, 40, 31, 31));
        in_button_save_cproxy = new QPushButton(page_cproxy);
        in_button_save_cproxy->setObjectName(QStringLiteral("in_button_save_cproxy"));
        in_button_save_cproxy->setGeometry(QRect(270, 30, 161, 27));
        ...
        page_vproxy->setGeometry(QRect(0, 0, 551, 163));
        ...
        in_text_vproxy_proxy_username->setGeometry(QRect(410, 100, 113, 27));
        ...
        in_text_vproxy_proxy_password->setGeometry(QRect(410, 130, 113, 27));
        ...
        page_sproxy->setGeometry(QRect(0, 0, 551, 163));
        ...
        in_text_sproxy_server->setGeometry(QRect(420, 0, 113, 27));
        ...
        in_button_save_sproxy->setGeometry(QRect(310, 110, 161, 27));
        ...
        in_text_sproxy_ssh_server->setGeometry(QRect(420, 70, 113, 27));
        label_21 = new QLabel(page_sproxy);
        label_21->setObjectName(QStringLiteral("label_21"));
        label_21->setGeometry(QRect(330, 70, 91, 20));
        ...
        page_tproxy->setGeometry(QRect(0, 0, 551, 163));
        ...
        in_text_tproxy_username->setGeometry(QRect(400, 10, 113, 27));
        ...
        in_button_save_tproxy->setGeometry(QRect(200, 100, 161, 27));
        ...
        page_new->setGeometry(QRect(0, 0, 551, 163));
    ...
    void retranslateUi(QMainWindow *AllProxy)
    {
        ...
        in_text_vproxy_path_6->setText(QApplication::translate("AllProxy", "Port", 0));
        in_button_save_cproxy->setText(QApplication::translate("AllProxy", "Save configuration", 0));
